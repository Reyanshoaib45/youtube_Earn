...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold mb-6 text-gray-800 dark:text-white">Manage Withdrawals</h1>
    ...
    <div class="flex justify-between items-center mb-6">
        <form action="{{ route('manager.withdrawals') }}" method="GET" class="flex items-center space-x-4">
...
<script>
    function openProcessWithdrawalModal(id, userName, amount) {
        ...
        document.getElementById('processWithdrawalForm').action = `/manager/withdrawals/${id}/process`;
