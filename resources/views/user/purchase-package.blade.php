        ...
        <div class="bg-white rounded-lg shadow-lg p-8 mb-8">
            ...
            <div class="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-lg p-6 mb-8">
                ...
                <div class="grid md:grid-cols-4 gap-4 text-center">
                    ...
                    <div>
                        <div class="text-lg font-bold text-green-600">Rs. {{ number_format($package->total_reward) }}</div>
                        <p class="text-sm text-gray-600">Total Reward</p>
                    </div>
                    <div>
                        <div class="text-lg font-bold text-purple-600">Rs. {{ number_format($package->total_reward - $package->price) }}</div>
                ...
                <div class="bg-red-50 border border-red-200 rounded-lg p-6">
                    ...
                    <div class="space-y-4">
                        <div class="bg-white rounded-lg p-4 border-2 border-red-300">
                            ...
                            <div class="flex items-center justify-between">
                                <span class="text-2xl font-bold text-red-600">03001234567</span>
                                <button onclick="copyJazzCashNumber()" class="bg-red-600 text-white px-3 py-1 rounded text-sm hover:bg-red-700">
                                    📋 Copy
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-lg p-4 border-2 border-red-300">
                            ...
                            <div class="text-2xl font-bold text-green-600">Rs. {{ number_format($package->price) }}</div>
                        </div>

                        <div class="bg-white rounded-lg p-4 border-2 border-red-300">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Account Title:</label>
                            <div class="text-lg font-semibold text-gray-800">Watch & Earn System</div>
                        </div>
                    </div>
                    ...
                    <div class="mt-6">
                        ...
                        <ol class="list-decimal list-inside space-y-2 text-sm text-red-700">
                            ...
                            <li>Enter the number: <strong>03001234567</strong></li>
                ...
                <div class="bg-green-50 border border-green-200 rounded-lg p-6">
                    ...
                    <form method="POST" action="{{ route('user.submit-purchase-request') }}">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Payment Details (Optional)</label>
                                <textarea name="payment_proof" 
                                          rows="3"
